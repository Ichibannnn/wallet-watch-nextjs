  ...
  return (
    <aside className="relative hidden overflow-hidden bg-[oklch(0.42_0.11_150)] text-white lg:flex lg:flex-col lg:justify-between lg:p-12">
      ...
      <div className="relative flex items-center gap-3">
        ...
        <span className="text-lg font-semibold tracking-tight">Wallet Watch</span>
      </div>
  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <rect x="70" y="52" width="200" height="34" rx="14" fill="oklch(0.30 0.08 150)" />
        <rect x="70" y="72" width="200" height="14" fill="oklch(0.30 0.08 150)" />
        <circle cx="248" cy="69" r="7" fill="white" />
        {/* Body lines */}
        <rect x="88" y="104" width="150" height="10" rx="5" fill="oklch(0.42 0.11 150)" opacity="0.35" />
        <rect x="88" y="122" width="110" height="10" rx="5" fill="oklch(0.42 0.11 150)" opacity="0.2" />
        {/* Amount chip */}
        <rect x="88" y="142" width="66" height="20" rx="6" fill="oklch(0.42 0.11 150)" />
        <text x="98" y="156" fontSize="12" fontWeight="700" fill="white" fontFamily="sans-serif">
          ₱ +
        </text>
        {/* Bubble tail */}
